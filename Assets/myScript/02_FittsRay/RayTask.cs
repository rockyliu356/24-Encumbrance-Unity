...
public class RayTask : MonoBehaviour
{
    ...
    public static List<float> scales = new List<float> { 0.06f, 0.06f, 0.06f, 0.04f, 0.04f, 0.04f, 0.08f, 0.08f, 0.08f };
    public static List<float> distances = new List<float> { 0.01f, 0.03f, 0.05f, 0.01f, 0.03f, 0.05f, 0.01f, 0.03f, 0.05f };
