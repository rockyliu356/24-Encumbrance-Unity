...
public class PointTask : MonoBehaviour
{
    ...
    public static List<float> scales = new List<float> { 0.06f, 0.06f, 0.06f, 0.05f, 0.05f, 0.05f, 0.07f, 0.07f, 0.07f };
    public static List<float> distances = new List<float> { 0.01f, 0.02f, 0.03f, 0.01f, 0.02f, 0.03f, 0.01f, 0.02f, 0.03f };
